...
*/
define(['text!../templates/scanner.tpl', 'models/DiagDataModel', 'i18n!nls/translations', 'backbone'],
	function(template, DiagDataModel, Translations){
		...
		var View = Backbone.View.extend({
			...
			*/
			initialize: function(){
				_.bindAll(this);
				this.dataModel = new DiagDataModel({url: '/rest/diagnostic/getioscannerdata'});
				this.listenTo(this.dataModel, 'change', this.updateDataPoints);
				this.dataModel.fetch({headers: { 'Authentication-Info': sessionStorage.getItem("authentication_info") }, success: this.generateView, silent: true});
				/* ggo */
